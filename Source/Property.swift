...
/// Specialized `PropertyProtocol` for the conjuction of a set of boolean properties.
public final class AndProperty: PropertyProtocol {
...
/// Specialized `PropertyProtocol` for the disjunction of a set of boolean properties.
public final class OrProperty: PropertyProtocol {
    public let terms: [Property<Bool>]
...
/// Specialized `PropertyProtocol` for the negation of a boolean property.
public final class NotProperty: PropertyProtocol {
    fileprivate let source: Property<Bool>
