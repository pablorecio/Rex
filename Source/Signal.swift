...
extension SignalProtocol {
    ...
    public func ignoreError(_ replacement: Event<Value, NoError> = .completed) -> Signal<Value, NoError> {
    ...
    public func timeoutAfter(_ interval: TimeInterval, withEvent event: Event<Value, Error>, onScheduler scheduler: DateSchedulerProtocol) -> Signal<Value, Error> {
